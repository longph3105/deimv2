...
**"DEIMv2 Materials"** means the original source code, model architectures, model weights, configuration files, scripts, documentation, and other materials developed by INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. and distributed as part of the DEIMv2 project.

**"Model Weights"** means trained or partially trained model parameters, checkpoints, and related files distributed by INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. as part of DEIMv2.
...
**"Third-Party Materials"** means software, models, weights, datasets, or other materials that are not owned by INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. and are included in or used by DEIMv2.

## 2. Grant of Rights

Subject to the terms of this License, INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. grants you a limited, worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and distribute the DEIMv2 Materials solely for Non-Commercial Purposes.

You may create and distribute modifications or derivative works of the DEIMv2 Materials for Non-Commercial Purposes, provided that such distribution complies with this License.

No rights are granted for Commercial Use.

## 3. Commercial Use

Commercial Use of the DEIMv2 Materials is **not permitted** under this License.

Commercial Use includes, but is not limited to:

- integrating DEIMv2 into a commercial product or service;
- deploying DEIMv2 in a commercial production environment;
- providing paid inference, training, or other services based on DEIMv2;
- operating a DEIMv2-based SaaS, API, or hosted service;
- incorporating DEIMv2 into commercial hardware or software; or
- redistributing DEIMv2 Materials for commercial purposes.
...
You may redistribute the DEIMv2 Materials or derivative works for permitted Non-Commercial Purposes provided that you:
...
DEIMv2 may include, depend on, or incorporate Third-Party Materials.

Third-Party Materials are **not covered by this License** and remain subject to their respective licenses.

In particular, DEIMv2 may use materials from projects such as D-FINE, DEIM, DINOv3, and other third-party projects. You must comply with the applicable licenses and terms governing those materials.
...
This License does not grant any rights to use the names, trademarks, or logos of INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. or DEIMv2 without prior written permission.

## 8. Termination

Your rights under this License automatically terminate if you materially violate its terms.

Upon termination, you must cease exercising the rights granted by this License, including use and distribution of the DEIMv2 Materials, to the extent permitted by applicable law.

## 9. Disclaimer

THE DEIMV2 MATERIALS ARE PROVIDED **"AS IS"**, WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED.
...
INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD. SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR OTHER DAMAGES ARISING FROM THE USE OF THE DEIMV2 MATERIALS, TO THE MAXIMUM EXTENT PERMITTED BY LAW.

## 10. Governing Law and Governing Terms

This License constitutes the agreement governing your use of the DEIMv2 Materials, except for Third-Party Materials, which remain subject to their respective licenses.
...
Project: https://github.com/Intellindust-AI-Lab/DEIMv2

---

**Summary:** DEIMv2 Materials are free for academic research and other Non-Commercial Purposes. **Commercial Use requires a separate license from INTELLINDUST INFORMATION TECHNOLOGY (SHENZHEN) CO., LTD.**
